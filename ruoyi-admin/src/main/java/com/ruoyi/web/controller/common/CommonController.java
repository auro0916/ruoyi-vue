...
import com.ruoyi.framework.service.S3FileService;
...
public class CommonController
{
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件到 S3
            String fileName = s3FileService.upload(file);

            // 当前暂时返回 S3 Object Key
            String url = fileName;
            ...
            HttpServletResponse response) throws Exception
    {
        try
        {
            ...
            {
                throw new Exception(
                        StringUtils.format("资源文件({})非法，不允许下载。", resource)
                );
            }
